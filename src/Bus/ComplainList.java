...
public class ComplainList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Employee", "Categrory ", "Date ", "Description"  }
        ) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ComplainList().setVisible(true);
            }
        });
    }
    ...
    public void listInJtable() {
        ...
        Object data[][] = {};
        Object col[] = {"Employee.", "Complain Type", "Date ", "Description "};
    ...
    public static String registrationList() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                res = res + enro_no + ":~" + name + ":~" + gender + ":~" + dob + ":~";
            }
            st.close();
            con.close();
